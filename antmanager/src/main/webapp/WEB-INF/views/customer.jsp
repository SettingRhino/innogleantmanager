				...
				<c:forEach var="customer" items="${customers}">
					<tr>
						...
						<td align="center"><a
							...
							class="btn btn-warning btn-large">수정</a> <a
							href="<c:url value="/viewCustomer?user=${customer.user}&id=${customer.id}"/>"
							class="btn btn-dark">상세보기</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
		<a href="<c:url value="/customers/addCustomer"/>"
